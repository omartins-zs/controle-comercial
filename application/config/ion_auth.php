...
$config['default_group']              = 'Vendedores';       // Default group, use name (grupo real cadastrado no schema, id 2)
$config['admin_group']                = 'Administrador';    // Default administrators group, use name (grupo real cadastrado no schema, id 1)
